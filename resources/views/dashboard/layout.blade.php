                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">{{ auth()->user()->nama_lengkap ?? 'Guest' }}</span>
                                @php($navAvatar = (auth()->user() && !empty(auth()->user()->avatar_path)) ? asset('storage/'.auth()->user()->avatar_path) : '/sb_admin/img/undraw_profile.svg')
                                <img class="img-profile rounded-circle" src="{{ $navAvatar }}" style="object-fit:cover">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Your Website 2025 | Absensi IoT</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
